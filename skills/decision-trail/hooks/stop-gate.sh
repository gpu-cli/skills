#!/usr/bin/env bash
# decision-trail: Claude Code Stop hook (Layer-2 enrichment gate).
#
...
#   { "hooks": { "Stop": [ { "hooks":
#       [ { "type":"command", "command":"bash .decision-trail/hooks/stop-gate.sh" } ] } ] } }
